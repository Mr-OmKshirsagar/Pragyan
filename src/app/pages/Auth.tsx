      ...
      >
        <GlassCard glow glowColor="primary" className="p-8">
          ...
          <div className="space-y-3">
            <button className="w-full py-3 px-4 bg-input-background border border-border rounded-lg hover:bg-muted/50 transition-all flex items-center justify-center gap-2">
